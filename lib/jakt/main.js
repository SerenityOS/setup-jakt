...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var revision, shouldCache, token, octokit, jaktPath, availableVersions, downloadedPath, extractedPath, _a, _b, buildPath, cmakeBinPath, _i, _c, p, cachedPath;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (!(jaktPath == undefined)) return [3 /*break*/, 12];
                ...
                case 12:
                    ...
                    return [4 /*yield*/, tc.cacheDir(jaktPath, "jakt", revision)];
                case 13:
                    cachedPath = _d.sent();
